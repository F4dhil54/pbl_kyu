            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextArea(
                    'Jelaskan secara singkat tujuan, ruang\nlingkup, dan target hasil proyek...',
                  ),
                  const SizedBox(height: 20),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          ...
          style: BorderStyle
              .solid, // Flutter doesn't have dashed border easily built-in without package, solid is fine or we can use custom painter. Let's stick to solid for simplicity, image looks dashed but border is enough. Wait, I can simulate it or just use solid.
        ),
      ),
      child: const Row(
        mainAxisSize: MainAxisSize.min,
